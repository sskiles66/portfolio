...
const slideshow = {
    projects: [{projectName: "Bountiful Foods", proImg: "images/bountislide.png", proDesc: "Bountiful Foods is a fictious company that we were assigned develop a website for in my Web Frontend 1 class. HTML, CSS, and JavaScript were used to develop this website.", link: 'https://sskiles66.github.io/wdd230/bountiful_foods/index.html'},
            ...
            {projectName: "Arlington Chamber of Commerce", proImg: "images/chamberslides.png", proDesc: "This Arlington Chamber of Commerce site was an assignment for my Web Frontend 1 class. I used HTML, CSS, and JavaScrpt to develop it.", link: "https://sskiles66.github.io/wdd230/chamber/index.html"},
            {projectName: "Stealth Game", proImg: "images/stealthslides.png", proDesc: "This is another small game that was made in Godot. The player controls a character and moves through a series of levels while avoiding sprites that have spotlights and if the player gets caught in them then its game over.", link: ""}]
}
